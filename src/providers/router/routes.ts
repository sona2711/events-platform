...
const RegistrationsTable = lazy(() =>
  import('@/components/RegistrationsTable').then((module) => ({
    default: module.RegistrationsTable,
  })),
)
...
export const registrationsPreviewRoute: RouteObject = {
  path: 'registrations-preview',
  element: createElement(RegistrationsTable),
}
